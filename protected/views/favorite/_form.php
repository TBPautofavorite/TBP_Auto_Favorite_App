...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		<?php echo $form->labelEx($model,'favorite_tweet'); ?>
		<?php echo $form->textField($model,'favorite_tweet',array('size'=>60,'maxlength'=>128)); ?>
		<?php echo $form->error($model,'favorite_tweet'); ?>
	</div>
